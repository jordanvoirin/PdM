...
sPDwthfolderPath = 'C:\Users\Jojo\Desktop\PdM-HEIG\Science\data\PD\astigmatism\angle_study_2\wth\full\*'
sPDwoutfolderPath = 'C:\Users\Jojo\Desktop\PdM-HEIG\Science\data\PD\astigmatism\angle_study_2\wout\full\'

sSHwthfolderPath = 'C:\Users\Jojo\Desktop\PdM-HEIG\Science\data\SHWFS\astigmatism\full\*'
sSHwoutfolderPath = 'C:\Users\Jojo\Desktop\PdM-HEIG\Science\data\SHWFS\astigmatism\full\'
...
PDwoutResult = phaseRetrievalrecropFits(sPDwoutfolderPath,jmax,707,482,118,1,1)
...
AnglesPD = []
resultsPD = list()
xcenter = [808,880,968,1075,1205]
ycenter = [476,472,467,461,455]
imgSize = 118
for iFol = 0, NPDfolders-1 do begin
  result = phaseRetrievalrecropFits(sPDwthFolderPaths[iFol]+'\',jmax,xcenter[iFol],ycenter[iFol],imgSize,1,1)
...
!null = LEGEND(target=[pA6Angleres,pA6Anglezon,pAstAnglezemax],/DATA);,pA6Anglesh,pAstAnglezemax],/DATA)
