...
\begin{enumerate}
\item Find the focus point on the camera using the python script \verb|AlignementScriptXimeaCamera.py|, see Appendix \ref{app:AlignementScriptXimeaCamera}. This script saves consecutively PSFs at different camera's position and computes their FWHM. And it highlights the minimum FWHM and the camera's position, see Figure \ref{fig:28092017AlignementXimeaPSFs}.
\begin{center}
\begin{figure}
