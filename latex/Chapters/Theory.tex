...
\begin{description}
\item[Fresnel Approximation] To reduce eqt. \eqref{eqt:Ray_Som_formula_xy_en}, also known as the Huygens-Fresnel principle, one can approximate the distance $r_{01}$ using the taylor expansion of the square root :
...
\item[Fraunhofer Approximation] In addition to the Fresnel approximation, we can introduce another approximation using the condition,
...
\section{Image with an instrument}
\label{sec:ImwthInst}
