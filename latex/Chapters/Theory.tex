...
\begin{equation}
i(x,y) = \iint_{-\infty}^{\infty}|h(x-\overset{\sim}{u},y-\overset{\sim}{v})|^2o(\overset{\sim}{u},\overset{\sim}{v})d\overset{\sim}{u}d\overset{\sim}{v},
\label{eqt:imageObjectrel}
\end{equation}

where $o(\overset{\sim}{u},\overset{\sim}{v}) = |U(\overset{\sim}{u},\overset{\sim}{v})|^2$. We can recognize the convolution of an object with an intensity impulse response.
