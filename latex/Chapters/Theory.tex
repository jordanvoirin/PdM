...
where S is the surface of a micro-lens and f is the focal length of the micro-lenses. The wavefront is reconstructed by integrating over all the local slope measurements. The advantage of this technique is that it do not require a lot of computation since it is a direct measurement. It is used in many fields, especially in adaptive optics system to correct for the atmospheric turbulence.
