...
In this chapter, we present the theory upon which this work is based. First, the light propagation formalism is reminded through the scalar diffraction theory based on the \citet{goodman_1968}. Then we describe in general an imaging system and its properties. And finally we discuss the wavefront aberration theory, and correction method to identify and correct the aberrations.
