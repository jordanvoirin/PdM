...
deltaZ = 3.19e-3
jmin = 4
jmax = np.array([10,20,30,50,100,150,200])
rmsWFerror = 30.
noiseStdLevel = 0.001
...
phaseDivWoutNoise = np.array([])
for jm in jmax:
    phaseDivWoutNoise = np.hstack((phaseDivWoutNoise,PD.phaseDiversity3PSFs(PSFinfoc.PSF,PSFoutfocpos.PSF,PSFoutfocneg.PSF,deltaZ,lbda,pxsize,F,pupilRadius,jmin,jm)))
